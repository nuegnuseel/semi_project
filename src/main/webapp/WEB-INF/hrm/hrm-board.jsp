    ...
    $('.view-button').click(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('input#empNo_view').val(response.empNo);
                $('input#ename_view').val(response.ename);
                $('input#birth_view').val(response.birthDate);
                ...
                $('input#mobile_view').val(response.mobile);
                $('input#position_view').val(response.posName);
                $('input#passport_view').val(response.passport);
                $('input#role_view').val(response.roleName);
                $('textarea#remarks_view').val(response.remarks);
                if (response.renameProfile && response.renameProfile.trim() !== "") {
                    $('#renameProfile_view').attr('src', '../upload/' + response.renameProfile);
                } else {
                                ...
                                <div class="profile-container">
                                    ...
                                    <div class="profile-details">
                                        <div class="row mb-sm-1 reduce-gap">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="hireDate_view" value="\${response.hireDate}"
                                                       readonly>
                                            </div>
                                            <label for="birth_view" class="col-sm col-form-label">생년월일</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="birth_view" value="\${response.birthDate}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-sm-1 reduce-gap">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="사원 이름" aria-label="ename"
                                                       readonly id="ename_view" name="ename_view" value="\${response.ename}">
                                            </div>
                                            <label for="deptName_view" class="col-sm col-form-label">부서명</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="deptName_view" value="\${response.deptName}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-sm-1 reduce-gap">
                                        ...
                                        <div class="row mb-3-sm-1">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="address_view"
                                                       value="\${response.address}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-sm-1 reduce-gap">
                                            <label for="mobile_view" class="col-sm col-form-label">전화</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="mobile_view" value="\${response.mobile}"
                                                       readonly>
                                            </div>
                                            <label for="position_view" class="col-sm col-form-label">직급</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="position_view" value="\${response.posName}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-sm-1 reduce-gap">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="passport_view" value="\${response.passport}"
                                                       readonly>
                                            </div>
                                            <label for="role_view" class="col-sm col-form-label">직책</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="role_view" value="\${response.roleName}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="form-row">
