...
@WebServlet("/attend/check/insert")
public class AttendCheckInsert extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/WEB-INF/attend/check-attend.jsp").forward(req, resp);
    }
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AttendDto attendDto = AttendDto.builder()
                ...
                .approval(req.getParameter("approval")) // 인쇄
                .build();
        ...
        if (result > 0) {
            ...
            resp.sendRedirect("/attend/check?AttendInsertSuccess=true");
        } else {
